...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            // Location
            // filament-locations v5 only creates countries/cities/areas with its database driver.
            foreach (['country_id' => 'countries', 'area_id' => 'areas', 'city_id' => 'cities', 'address_id' => 'locations'] as $column => $foreignTable) {
